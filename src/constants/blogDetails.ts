...
import bannerPic1 from '../assets/individualBlog/banner.png';
import blogAuthor2 from '../assets/individualBlog/blogAuthor-1.png';
import blogAuthorLargeImg2 from '../assets/individualBlog/blogAuthorLarge-1.png';
import bannerPic2 from '../assets/individualBlog/banner.png';
import blogAuthor3 from '../assets/individualBlog/blogAuthor-1.png';
import blogAuthorLargeImg3 from '../assets/individualBlog/blogAuthorLarge-1.png';
import bannerPic3 from '../assets/individualBlog/banner.png';
...
AI is here to make your work-life better. By automating boring tasks, giving you smart insights, and helping you manage more projects, AI lets you focus on what truly matters—thinking creatively, solving real problems, and delivering your best work.`,
  },
  {
    ...
    body1: `The rapid advancement of Artificial Intelligence has sparked widespread concerns about job security. Many fear that machines will eventually replace human workers across industries. However, the reality is far more nuanced. AI is not here to take your job; instead, it is poised to transform how you work. Rather than replacing humans, AI will automate repetitive and mundane tasks, allowing professionals to focus on higher-value activities that require creativity, empathy, and critical thinking—skills that machines cannot replicate.`,
    body2: `Final Thoughts:
AI isn’t a job killer—it’s a job shifter. While some routine roles will be automated, countless new opportunities will emerge for those who embrace the change.`,
  },
  {
    id: 6,
    heading1: "AI Helps You Work",
