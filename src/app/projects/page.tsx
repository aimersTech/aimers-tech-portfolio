                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-3">
                    <Link href={`/projects/${project.id}`}>
                      <Button
                        size="sm"
                        className="bg-cyan-600 hover:bg-cyan-700 text-white px-4 py-2 text-xs cursor-pointer"
                      >
                        View Project
                      </Button>
                    </Link>
                    ...
                    >
                      <Button
                        variant="outline"
                        size="sm"
                        className="border-gray-600 text-gray-300 hover:bg-gray-800 px-4 py-2 text-xs bg-transparent cursor-pointer"
                      >
                        Code
                      </Button>
                    </Link>
